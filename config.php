<?php session_start(); ?>
<?php
define("DATABASE", "tmmovipme_mmovip");//tên database
define("USERNAME", "tmmovipme_mmovip");//tên tài khoản quản lí database
define("PASSWORD", "tmmovipme_mmovip");//mật khẩu tài khoản
